...
const Index = () => {
  return (
    <div className="sm:text-left text-center">
      <section className="bg-secondary py-5 px-3">
        <div className="flex justify-between container mx-auto md:max-w-6xl">
          <span className=" text-white bg-secondaryLight cursor-pointer rounded-md py-2 px-6 mr-3 sm:mr-0">
            New!
          </span>
          <p className="text-white border-b hidden xs:inline-block pb-0">
            Announcing our $15 million4series A funding!
          </p>
          <Link to="/IndexMain">
        ...
        <p className="text-white underline xs:hidden mt-3">
          Announcing our $15 million4series A funding!
        </p>
      </section>
        ...
        <div className="container mx-auto md:max-w-5xl max-w-6xl lg:px-0 px-5 pt-8 pb-12">
          ...
          <section className="mission_section" id="mission">
            <div className="md:flex justify-between mt-16">
              <div className="text-white leading-loose lg:mr-0 mr-5">
      ...
      <main>
        <section className="goal__section">
          <div className="md:flex justify-between md:my-10 container mx-auto md:max-w-5xl max-w-6xl p-5 lg:p-0">
            <div className="leading-loose lg:mr-0  mr-5">
